package com.yanyiyun.baseutils.step.service;
...
import com.yanyiyun.baseutils.step.UpdateStepActivity;
import com.yanyiyun.baseutils.step.UpdateUiCallBack;
import com.yanyiyun.baseutils.step.accelerometer.StepCount;
import com.yanyiyun.baseutils.step.accelerometer.StepValuePassListener;
import com.yanyiyun.baseutils.step.bean.StepData;
import com.yanyiyun.baseutils.step.utils.DbUtils;
...
//                    Logger.d("重置步数" + StepDcretor.CURRENT_STEP);
    ...
    private void updateNotification() {
        //设置点击跳转
        Intent hangIntent = new Intent(this, UpdateStepActivity.class);
    ...
    public void onSensorChanged(SensorEvent event) {
        if (stepSensorType == Sensor.TYPE_STEP_COUNTER) {
            ...
            Log.e("tempStep","tempStep" + tempStep);
    ...
    public void onDestroy() {
        ...
        Log.e("stepService关闭","stepService关闭");
    }
